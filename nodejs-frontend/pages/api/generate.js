...
async function getVespaResults(query) {
  ...
  if(children.length > 0) {
    var context = "Here is the results of a person's quiz. Each answer is formatted as topic:score where a score of 0 is them being extremely unaligned to a topic and a score of 1 is them being extremely aligned with a topic, which you can use to answer the question:";
    ...
    context = context + "\n" + "Now write a list of 5 real life career paths which might align with their interests."
