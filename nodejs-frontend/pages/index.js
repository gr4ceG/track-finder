...
export default function Home() {
  ...
  const [chatHistory, setChatHistory] = useState([
    { role: "system", content: "Please insert you index scores:" },
  ]);
  ...
  return (
    <div>
      <Head>
        <title>Vespa RAG template</title>
      </Head>
      <h1 className={styles.heading1}>Vespa RAG template</h1>
      ...
      <div className={styles.messageInputContainer}>
        <form onSubmit={onSubmit}>
          <input
            ...
            name="message"
            placeholder="Type your index scores here..."
            required
            value={message}
